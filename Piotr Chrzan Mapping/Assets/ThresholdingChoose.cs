...
public class ThresholdingChoose : MonoBehaviour {
	...
	void Start () {
        ...
        Button SetBracketing = Bracketing.GetComponent<Button>();
        Bracketing.onClick.AddListener(ThresholdTypeBracketing);
    ...
    public void ThresholdTypeBracketing()
    {
        ThresholdingType.VideoThresholdMode = ARController.ARToolKitThresholdMode.Bracketing;
    }
